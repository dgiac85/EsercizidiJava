...
public class Iterators
{
    public static void main(String args[])
    {
        ...
        ListIterator<String> it_os = al_operating_systems.listIterator(); // oggetto ListIterator

        System.out.println("Sistemi operativi partendo dall'inizio della lista..."); // parte dall'inizio
        while (it_os.hasNext())
            System.out.print(it_os.next() + " ");

        System.out.println("\nSistemi operativi partendo dalla fine della lista..."); // parte dalla fine
        ...
        while (it_os.hasNext())
        {
            ...
            if (n_e.contains("Solaris"))
            {
                ...
                n_e = it_os.previous(); // ritorniamo indietro e poi avanti per far vedere la modifica!
                n_e = it_os.next();
            }
            ...
            if (n_e.contains("FreeBSD"))
            {
                ...
                n_e = it_os.previous(); // ritorniamo indietro e poi avanti per far vedere l'aggiunta!
                n_e = it_os.next();
            }
