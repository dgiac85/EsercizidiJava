...
class ClassE // PROPRIO SCOPE - OUTER SCOPE
{
    ...
    {
        // qui è usato il parametro width che nasconde la variabile di istanza width
        int w = width;

        // qui è usata la variabile di istanza width tramite l'uso di this
        int w2 = this.width;

        // prefix di ClassE è nascosta dalla variabile locale prefix
        String prefix = ";;;";
        System.out.println("In setWidth prefix è: " + prefix);
    }
}
...
class ClassF  // PROPRIO SCOPE - OUTER SCOPE
{
    ...
    {
        // il parametro flag nasconde la variabile di istanza flag
        int _f = flag;

        // la variabile locale value nasconde la variabile di istanza value
        int value = 200;
        return value == _f;
    };
    ...
    public void test(int flag) // PROPRIO SCOPE - INNER SCOPE
    {
        ...
        IntPredicate p1 = new IntPredicate() // PROPRIO SCOPE
        {
            public boolean test(int value)
            {
                ...
                // qui value nasconde la variabile di istanza value 
...
public class ScopingRules
{
    public static void main(String args[])
    {
        ...
        // Si riferisce ad entità distinte.
        // Qui lo riferiamo qualificandolo con la classe di appartenenza
        System.out.println("ClassA.NUMBER = " + ClassA.NUMBER + "; ClassB.NUMBER = " + ClassB.NUMBER);

        System.out.println("ClassC.SIZE = " + ClassC.SIZE + "; ClassD.SIZE = " + ClassC.ClassD.SIZE);
